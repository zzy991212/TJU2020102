    ...
    Silder.prototype.createTemplate = function () {
        ...
        var str = `
            <div class="zui-slider ${ss.disable? 'zui-disabled': ''}">
                <div class="zui-slider-tips" style="left: ${ss.pos}; display: none">1946</div>
        ...
        ss.silderTips.text(Math.round(ss.num / 100 * ss.count) + 1946)
        make_reci_echarts(Math.round(ss.num / 100 * ss.count) + 1946)
    }
})(window)